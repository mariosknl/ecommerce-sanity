...
const Orders = async () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4">
      <div className="bg-white p-4 sm:p-0 rounded-xl shadow-lg w-full max-w-4xl">
            ...
            {orders.map((order) => (
              ...
              >
                <div className="p-4 sm:p-6 border-b border-gray-200">
                  ...
                  <div className="flex flex-col gap-4 sm:flex-row sm:flex-justify-between sm:items-center">
